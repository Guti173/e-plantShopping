        ...
        <div style={styleObjUl}>
          ...
          <a href="#" onClick={handleCartClick} style={styleA}>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" height="32" width="32">
              ...
              <path d="M42.3,72H221.7l-26.4,92.4A15.9,15.9,0,0,1,179.9,176H84.1a15.9,15.9,0,0,1-15.4-11.6L32.5,37.8A8,8,0,0,0,24.8,32H8" fill="none" stroke="#fff" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
            </svg>
          </a>
        </div>
      </div>
